        ...
        <table className="w-full table-auto border-collapse shadow-lg">
          ...
          <tbody>
            {[
              ...
              {
                item: "Outer Upper Plate",
                recipe: "1x Metal Plate & 6x Nails.",
              },
              {
                item: "Outer Lower Plate",
                recipe: "1x Metal Plate & 6x Nails.",
              },
              { item: "Inner Upper Planks", recipe: "5x Plank & 5x Nails." },
              { item: "Inner Lower Planks", recipe: "5x Plank & 5x Nails." },
              {
                item: "Inner Upper Plate",
                recipe: "1x Metal Plate & 5x Nails.",
              },
              {
                item: "Inner Lower Plate",
                recipe: "1x Metal Plate & 5x Nails.",
              },
              { item: "Barricade Holders", recipe: "1x Plank & 4x Nails." },
              {
                item: "Centre Barricade Holder",
                recipe: "1x Plank & 2x Nails.",
              },
